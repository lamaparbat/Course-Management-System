...
public class Tutors extends javax.swing.JFrame {
    ...
    private void initComponents() throws SQLException, ClassNotFoundException {
        ...
        tutor_btn.setBackground(new java.awt.Color(255, 153, 153));
        ...
        jLabel50.setIcon(new javax.swing.ImageIcon("/Users/parbatlama/Pictures/icons/teachers2.png")); // NOI18N
...
//        activity_table.getColumnModel().getColumn(4).setCellRenderer(centerRenderer);
        ...
        dashboard_title.setText("Tutors");
        ...
        delete_btn.setText("Delete Tutors");
